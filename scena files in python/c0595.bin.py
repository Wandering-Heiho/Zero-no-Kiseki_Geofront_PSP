...
def main():
    ...
    Sepith("Sepith_A4", 0,   10,  20,  5,   20,  0,   0)
    Sepith("Sepith_B4", 16,  0,   0,   0,   12,  12,  12)
    Sepith("Sepith_C4", 0,   15,  0,   20,  20,  0,   0)
    ...
    BattleInfo(
        "BattleInfo_144", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_A4", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_20C", 0x0000, 33, 6, 60, 4, 1, 30, 0, "bc0540", "Sepith_B4", 40, 30, 20, 10,
        (
            ...
            ("ms76500.dat", "ms76500.dat", "ms76500.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
            ("ms76500.dat", "ms76500.dat", "ms76500.dat", "ms76500.dat", 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_2D4", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_C4", 40, 30, 20, 10,
        (
            ("ms76700.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
            ("ms76700.dat", "ms76700.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
            ("ms76700.dat", "ms76700.dat", "ms76700.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
            ("ms76700.dat", "ms76700.dat", "ms76700.dat", "ms76700.dat", 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_39C", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_D4", 40, 30, 20, 10,
        (
            ...
            ("ms76900.dat", "ms76900.dat", "ms76900.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
            ("ms76900.dat", "ms76900.dat", "ms76900.dat", "ms76900.dat", 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7400", "ed7403", "ATBonus_94"),
        )
    )
    ...
    DeclMonster(-19740,  -4460,   1500,    0x1010000,    "BattleInfo_144", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(-26110,  7760,    0,       0x1010000,    "BattleInfo_20C", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(-33300,  -6030,   0,       0x1010000,    "BattleInfo_2D4", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(-3460,   3290,    3030,    0x1010000,    "BattleInfo_144", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(-32100,  14020,   3030,    0x1010000,    "BattleInfo_39C", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-6380,   15850,   3000,    0x1010000,    "BattleInfo_2D4", 0,   20,  0xFFFF, 4,  5)
    ...
    def Function_0_668(): pass

    label("Function_0_668")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 3)), scpexpr(EXPR_END)), "loc_7A7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x113, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C22")
    OP_70(0x0, 0x0)
    Jump("loc_C26")
    ...
    def Function_2_C27(): pass

    label("Function_2_C27")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x113, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D11")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x84, 1)"), scpexpr(EXPR_END)), "loc_CA7")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "You find a veritable mountain of chest messages\x01",
            "that were considered too crude for publication.\x07\x00\x02",
        )
    )
    ...
    def Function_3_DA7(): pass

    label("Function_3_DA7")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_E7E")
    Fade(500)
    ...
    def Function_4_E86(): pass

    label("Function_4_E86")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_F5D")
    Fade(500)
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 3)), scpexpr(EXPR_END)), "loc_1082")
    Fade(500)
    Sound(140, 0, 100, 0)
    SetMapObjFrame(0xFF, "lgt1_add", 0x1, 0x1)
    SetMapObjFrame(0xFF, "lgt2_add", 0x0, 0x1)
