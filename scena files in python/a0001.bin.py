...
def main():
    ...
    ScpFunction((
        ...
        "Function_7_118B",         # 07, 7
        "Function_8_11A3",         # 08, 8
        "Function_9_11BB",         # 09, 9
        "Function_10_11D3",        # 0A, 10
        "Function_11_11EB",        # 0B, 11
        "Function_12_120A",        # 0C, 12
        "Function_13_1229",        # 0D, 13
        "Function_14_1246",        # 0E, 14
        "Function_15_128D",        # 0F, 15
        "Function_16_12BC",        # 10, 16
        "Function_17_12D0",        # 11, 17
        "Function_18_1309",        # 12, 18
        "Function_19_1350",        # 13, 19
        "Function_20_1370",        # 14, 20
        "Function_21_13AF",        # 15, 21
        "Function_22_13E5",        # 16, 22
        "Function_23_141B",        # 17, 23
        "Function_24_1450",        # 18, 24
    ))
    ...
    MenuEnd(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_776")
    Call(0, 3)
    Jump("loc_777")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_116C")
    Call(0, 4)
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_118A")
    OP_A0(0xFE, 1500, 0x0, 0x2)
    Jump("Function_6_1173")
    ...
    def Function_7_118B(): pass

    label("Function_7_118B")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_11A2")
    OP_A0(0xFE, 1500, 0x0, 0x4)
    Jump("Function_7_118B")
    ...
    def Function_8_11A3(): pass

    label("Function_8_11A3")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_11BA")
    OP_A0(0xFE, 1500, 0x0, 0x5)
    Jump("Function_8_11A3")
    ...
    def Function_9_11BB(): pass

    label("Function_9_11BB")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_11D2")
    OP_A0(0xFE, 1500, 0x0, 0x6)
    Jump("Function_9_11BB")
    ...
    def Function_10_11D3(): pass

    label("Function_10_11D3")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_11EA")
    OP_A0(0xFE, 1500, 0x0, 0x7)
    Jump("Function_10_11D3")

    label("loc_11EA")

    Return()

    # Function_10_11D3 end

    def Function_11_11EB(): pass

    label("Function_11_11EB")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1209")
    OP_A1(0xFE, 0x4B0, 0x8, 0x0, 0x1, 0x2, 0x3, 0x4, 0x3, 0x2, 0x1)
    Jump("Function_11_11EB")

    label("loc_1209")

    Return()

    # Function_11_11EB end

    def Function_12_120A(): pass

    label("Function_12_120A")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1228")
    OP_A1(0xFE, 0x5DC, 0x8, 0x0, 0x1, 0x2, 0x1, 0x0, 0x3, 0x4, 0x3)
    Jump("Function_12_120A")

    label("loc_1228")

    Return()

    # Function_12_120A end

    def Function_13_1229(): pass

    label("Function_13_1229")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1245")
    OP_A1(0xFE, 0x3E8, 0x3, 0x1, 0x2, 0x3)
    Sleep(1000)
    Jump("Function_13_1229")

    label("loc_1245")

    Return()

    # Function_13_1229 end
    ...
    def Function_15_128D(): pass

    label("Function_15_128D")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_12BB")
    SetChrChipByIndex(0xFE, 0x20)
    OP_A1(0xFE, 0x6A4, 0x6, 0x0, 0x0, 0x1, 0x1, 0x2, 0x2)
    OP_A1(0xFE, 0x6A4, 0x5, 0x3, 0x4, 0x5, 0x6, 0x7)
    Sleep(1000)
    Jump("Function_15_128D")

    label("loc_12BB")

    Return()

    # Function_15_128D end

    def Function_16_12BC(): pass

    label("Function_16_12BC")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_12CF")
    Sleep(1000)
    Jump("Function_16_12BC")

    label("loc_12CF")

    Return()

    # Function_16_12BC end

    def Function_17_12D0(): pass

    label("Function_17_12D0")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1308")
    ...
    Sleep(500)
    Jump("Function_17_12D0")

    label("loc_1308")

    Return()

    # Function_17_12D0 end

    def Function_18_1309(): pass

    label("Function_18_1309")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_134F")
    SetChrChipByIndex(0xFE, 0x0)
    ...
    Sleep(1000)
    Jump("Function_18_1309")

    label("loc_134F")

    Return()

    # Function_18_1309 end

    def Function_19_1350(): pass

    label("Function_19_1350")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_136F")
    OP_A1(0xFE, 0x708, 0x6, 0x0, 0x1, 0x2, 0x3, 0x4, 0x0)
    Sleep(1000)
    Jump("Function_19_1350")

    label("loc_136F")

    Return()

    # Function_19_1350 end

    def Function_20_1370(): pass

    label("Function_20_1370")
    ...
    Sleep(1000)
    Jump("Function_20_1370")

    label("loc_13AE")

    Return()

    # Function_20_1370 end

    def Function_21_13AF(): pass

    label("Function_21_13AF")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_13E4")
    SetChrChipByIndex(0xFE, 0xA)
    SetChrSubChip(0xFE, 0x4)
    Sleep(500)
    ...
    Jump("Function_21_13AF")

    label("loc_13E4")

    Return()

    # Function_21_13AF end

    def Function_22_13E5(): pass

    label("Function_22_13E5")
    ...
    OP_A1(0xFE, 0x960, 0x6, 0x0, 0x1, 0x2, 0x2, 0x2, 0x3)
    OP_A1(0xFE, 0x960, 0x4, 0x4, 0x5, 0x6, 0x7)
    Jump("Function_22_13E5")

    label("loc_141A")

    Return()

    # Function_22_13E5 end

    def Function_23_141B(): pass

    label("Function_23_141B")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_144F")
    SetChrChipByIndex(0xFE, 0x14)
    ...
    OP_A1(0xFE, 0x960, 0x4, 0x4, 0x5, 0x6, 0x7)
    Jump("Function_23_141B")

    label("loc_144F")

    Return()

    # Function_23_141B end

    def Function_24_1450(): pass

    label("Function_24_1450")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1485")
    ...
    OP_A1(0xFE, 0x960, 0x6, 0x0, 0x1, 0x2, 0x2, 0x2, 0x3)
    OP_A1(0xFE, 0x960, 0x4, 0x4, 0x5, 0x6, 0x7)
    Jump("Function_24_1450")

    label("loc_1485")

    Return()

    # Function_24_1450 end
