...
def main():
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1D1")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x2, 0x1E)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1ED")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
    ...
    def Function_3_1EE(): pass

    label("Function_3_1EE")
