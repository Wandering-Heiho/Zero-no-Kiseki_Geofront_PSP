...
def main():
    ...
    CreateScenaFile(
        ...
        # Information
        [0, 0, -1000, 0, 0, 0, 34000, 262, 30, 45, 0, 360, 0, 2000, -30000, 0, 0, 1, 113, 0, 0, 0, 1],
    )
    ...
    Sepith("Sepith_A4", 13,  0,   0,   6,   6,   5,   5)
    Sepith("Sepith_B4", 6,   6,   6,   12,  2,   2,   2)
    ...
    BattleInfo(
        "BattleInfo_124", 0x0000, 21, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_A4", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_1EC", 0x0000, 21, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_B4", 40, 30, 20, 10,
        (
    ...
    DeclMonster(-19230,  70,      0,       0x1010000,    "BattleInfo_124", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(22310,   -8980,   1990,    0x1010000,    "BattleInfo_1EC", 0,   18,  0xFFFF, 2,  3)
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_615")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x0, 0x1E)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_631")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
