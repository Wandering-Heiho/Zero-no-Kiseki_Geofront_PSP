...
def main():
    ...
    Sepith("Sepith_A4", 0,   26,  8,   8,   0,   0,   8)
    Sepith("Sepith_B4", 1,   19,  0,   26,  1,   0,   3)
    ...
    BattleInfo(
        "BattleInfo_124", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2050", "Sepith_A4", 40, 30, 20, 10,
        (
            ("ms73500.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73500.dat", "ms73500.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73500.dat", "ms73500.dat", "ms73500.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73500.dat", "ms73500.dat", "ms73500.dat", "ms73500.dat", 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_1EC", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2050", "Sepith_B4", 40, 30, 20, 10,
        (
            ("ms74700.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms74700.dat", "ms73500.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms74700.dat", "ms73500.dat", "ms73500.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms74700.dat", "ms73500.dat", "ms73500.dat", "ms73500.dat", 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
        )
    )
    ...
    DeclMonster(-180,    15080,   0,       0x1010000,    "BattleInfo_124", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(25760,   10760,   -1500,   0x1010000,    "BattleInfo_1EC", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(51830,   1210,    0,       0x1010000,    "BattleInfo_124", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(50920,   34460,   0,       0x1010000,    "BattleInfo_124", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(26140,   47580,   -1500,   0x1010000,    "BattleInfo_1EC", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(2750,    48100,   0,       0x1010000,    "BattleInfo_124", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(14460,   17410,   -1490,   0x1010000,    "BattleInfo_1EC", 0,   18,  0xFFFF, 2,  3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_48E")
    StopEffect(0x80, 0x0)
    StopEffect(0x81, 0x0)

    label("loc_48E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_4DD")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4F7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B5B")
    OP_70(0x1, 0x0)
    Jump("loc_B5F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B72")
    OP_70(0x2, 0x0)
    Jump("loc_B76")
    ...
    def Function_2_B93(): pass

    label("Function_2_B93")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C7D")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x87, 1)"), scpexpr(EXPR_END)), "loc_C13")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Bad news, pal. You're looking at the baddest\x01",
            "jaeger in all of chestern Zemuria.\x07\x00\x02",
        )
    )
    ...
    def Function_3_D03(): pass

    label("Function_3_D03")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DED")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_D83")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
