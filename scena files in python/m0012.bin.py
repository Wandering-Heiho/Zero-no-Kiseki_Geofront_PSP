...
def main():
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3A4")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x4, 0x1E)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_3C0")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x54, 5)), scpexpr(EXPR_END)), "loc_414")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_5D4")
    Fade(500)
    ...
    QueueWorkItem(0x0, 2, lambda_523)
    Sleep(500)
    ...
    QueueWorkItem(0x1, 2, lambda_533)
    Sleep(10)
    ...
    QueueWorkItem(0x2, 2, lambda_543)
    Sleep(10)
    ...
    QueueWorkItem(0x3, 2, lambda_553)
    Sleep(500)
    Fade(500)
