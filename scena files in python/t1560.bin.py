...
def main():
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x66), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_248")
    MenuCmd(0, 0)
    MenuCmd(1, 0, "★[ 3F ]")
    MenuCmd(1, 0, "　[ 2F ]")
    MenuCmd(1, 0, "　[ 1F ]")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x65), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2A2")
    MenuCmd(0, 0)
    MenuCmd(1, 0, "　[ 3F ]")
    MenuCmd(1, 0, "★[ 2F ]")
    MenuCmd(1, 0, "　[ 1F ]")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x64), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2F7")
    MenuCmd(0, 0)
    MenuCmd(1, 0, "　[ 3F ]")
    MenuCmd(1, 0, "　[ 2F ]")
    MenuCmd(1, 0, "★[ 1F ]")
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_31E")
    FadeToDark(500, 0, -1)
    OP_0D()
    Jump("loc_39B")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x2), scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_357")
    FadeToDark(2000, 0, -1)
    Sound(159, 0, 100, 0)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x2), scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_390")
    FadeToDark(2000, 0, -1)
    Sound(159, 0, 100, 0)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3FB")
    Switch(
        (scpexpr(EXPR_GET_RESULT, 0x2), scpexpr(EXPR_END)),
        (0, "loc_3C6"),
        (1, "loc_3D6"),
        (2, "loc_3E6"),
        (SWITCH_DEFAULT, "loc_3F6"),
    )
