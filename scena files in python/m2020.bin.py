...
def main():
    ...
    Sepith("Sepith_C4", 12,  0,   0,   7,   16,  16,  0)
    Sepith("Sepith_D4", 0,   27,  0,   0,   20,  1,   2)
    Sepith("Sepith_E4", 10,  5,   5,   4,   4,   8,   15)
    Sepith("Sepith_F4", 13,  0,   8,   8,   13,  8,   0)
    ...
    BattleInfo(
        "BattleInfo_164", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_B4", 40, 30, 20, 10,
        (
            ("ms73400.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73400.dat", "ms73400.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73400.dat", "ms73400.dat", "ms73400.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73400.dat", "ms73400.dat", "ms73400.dat", "ms73400.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_22C", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_C4", 40, 30, 20, 10,
        (
            ("ms73600.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73600.dat", "ms73600.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73600.dat", "ms73600.dat", "ms73600.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73600.dat", "ms73600.dat", "ms73600.dat", "ms73600.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_2F4", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_D4", 60, 25, 10, 5,
        (
            ("ms73000.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73000.dat", "ms73000.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73000.dat", "ms73000.dat", "ms73000.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73000.dat", "ms73000.dat", "ms73000.dat", "ms73000.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_3BC", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_E4", 50, 50, 0, 0,
        (
            ("ms74000.dat", "ms73400.dat", "ms73400.dat", "ms73400.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms74000.dat", "ms73000.dat", "ms73000.dat", "ms73000.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            (),
            (),
        )
    )
    ...
    BattleInfo(
        "BattleInfo_42C", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_F4", 40, 30, 20, 10,
        (
            ("ms73700.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73700.dat", "ms73700.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73700.dat", "ms73700.dat", "ms73700.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
            ("ms73700.dat", "ms73700.dat", "ms73700.dat", "ms73700.dat", 0, 0, 0, 0, "MonsterBattlePostion_144", "MonsterBattlePostion_124", "ed7400", "ed7403", "ATBonus_94"),
        )
    )
    ...
    BattleInfo(
        "BattleInfo_4F4", 0x0000, 30, 6, 0, 6, 1, 0, 0, "bm2020", 0x00000000, 100, 0, 0, 0,
        (
            ("ms74000.dat", "ms74000.dat", "ms74000.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_124", "ed7401", "ed7403", "ATBonus_A4"),
            (),
            (),
            (),
        )
    ...
    DeclMonster(18720,   107870,  4000,    0x1010000,    "BattleInfo_164", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(107540,  110600,  8000,    0x1010000,    "BattleInfo_22C", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(114280,  210730,  12000,   0x1010000,    "BattleInfo_2F4", 0,   24,  0xFFFF, 8,  9)
    DeclMonster(110070,  307650,  16000,   0x1010000,    "BattleInfo_3BC", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(207210,  210690,  16000,   0x1010000,    "BattleInfo_42C", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(111200,  4130,    12000,   0x1010000,    "BattleInfo_164", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(207130,  -2710,   16000,   0x1010000,    "BattleInfo_3BC", 0,   20,  0xFFFF, 4,  5)
    ...
    ScpFunction((
        ...
        "Function_3_E73",          # 03, 3
        "Function_4_F61",          # 04, 4
        "Function_5_10D5",         # 05, 5
    ))


    def Function_0_774(): pass

    label("Function_0_774")
    ...
    def Function_1_791(): pass

    label("Function_1_791")

    Return()

    # Function_1_791 end

    def Function_2_792(): pass

    label("Function_2_792")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_7A4")
    OP_50(0x1, (scpexpr(EXPR_PUSH_LONG, 0x130), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))

    label("loc_7A4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_7B3")
    StopEffect(0x80, 0x0)
    StopEffect(0x81, 0x0)

    label("loc_7B3")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_815")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_END)), "loc_864")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E44")
    OP_70(0x0, 0x0)
    Jump("loc_E48")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E5B")
    OP_70(0x1, 0x0)
    Jump("loc_E5F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E6F")
    Sound(129, 1, 100, 0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x66), scpexpr(EXPR_NEQ), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x67), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_E94")
    SetChrFlags(0x9, 0x8)
    Jump("loc_E99")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x68), scpexpr(EXPR_NEQ), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x69), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6A), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_EC3")
    SetChrFlags(0xA, 0x8)
    Jump("loc_EC8")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6B), scpexpr(EXPR_NEQ), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6C), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6D), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_EF2")
    SetChrFlags(0xB, 0x8)
    Jump("loc_EF7")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6F), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_F0F")
    SetChrFlags(0xD, 0x8)
    Jump("loc_F14")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_NEQ), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x71), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_F35")
    SetChrFlags(0xE, 0x8)
    Jump("loc_F3A")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x72), scpexpr(EXPR_NEQ), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x73), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_F5B")
    SetChrFlags(0xF, 0x8)
    Jump("loc_F60")
    ...
    def Function_4_F61(): pass

    label("Function_4_F61")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_104B")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_FE1")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "You feel a sharp gaze stare at you from inside the void.\x01",
            "Whose eyes are those eyes?\x07\x00\x02",
        )
    )
    ...
    def Function_5_10D5(): pass

    label("Function_5_10D5")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1294")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x75, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_11D4")
    ...
    QueueWorkItem(0x8, 1, lambda_112E)

    def lambda_1148():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x3E8)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_1148)
    ...
    OP_57(0x0)
    WaitChrThread(0x8, 1)
    Battle("BattleInfo_4F4", 0x0, 0x0, 0x0, 0x0, 0xFF)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x64E, 1)"), scpexpr(EXPR_END)), "loc_122C")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    AnonymousTalk(
        ...
        (
            scpstr(0x6),
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "This chest is as empty as your soul!\x01",
            "Chestkind ill needs a looter such as you!\x07\x00\x02",
        )
    )
