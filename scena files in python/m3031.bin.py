...
def main():
    ...
    Sepith("Sepith_D4", 5,   18,  5,   5,   12,  12,  12)
    ...
    BattleInfo(
        "BattleInfo_144", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_A4", 60, 25, 10, 5,
        (
            ("ms60700.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms60700.dat", "ms77300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms60700.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms60700.dat", "ms77300.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_20C", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3030", "Sepith_B4", 60, 25, 10, 5,
        (
            ("ms61500.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms61500.dat", "ms77300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms61500.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms61500.dat", "ms77300.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_2D4", 0x0000, 43, 6, 60, 4, 1, 60, 0, "bm3030", "Sepith_C4", 60, 25, 10, 5,
        (
            ("ms72500.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms72500.dat", "ms77300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms72500.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms72500.dat", "ms77300.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_39C", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_D4", 60, 25, 10, 5,
        (
            ("ms75300.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms75300.dat", "ms77300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms75300.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_E4", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
            ("ms75300.dat", "ms77300.dat", "ms77300.dat", "ms77300.dat", 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_104", "ed7402", "ed7403", "ATBonus_94"),
        )
    )
    ...
    DeclMonster(-28800,  -14090,  -7000,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-40820,  -520,    3000,    0x1010000,    "BattleInfo_20C", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(133590,  14320,   0,       0x1010000,    "BattleInfo_2D4", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(144880,  -29970,  -4500,   0x1010000,    "BattleInfo_39C", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(169360,  -1300,   -4500,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 0,  1)
    ...
    def Function_0_644(): pass

    label("Function_0_644")

    Return()

    # Function_0_644 end

    def Function_1_645(): pass

    label("Function_1_645")

    ClearMapObjFlags(0x3, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xF5, 5)), scpexpr(EXPR_END)), "loc_661")
    OP_70(0x6, 0x96)
    OP_70(0x3, 0x1E)
    Jump("loc_669")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A5A")
    OP_70(0x4, 0x0)
    Jump("loc_A5E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A71")
    OP_70(0x5, 0x0)
    Jump("loc_A75")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x68), scpexpr(EXPR_EQU), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x69), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6A), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6B), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6C), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x6D), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_AB8")
    OP_24(0x82)
    Jump("loc_ABE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BA9")
    Sound(14, 0, 100, 0)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_B3F")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Hello, darkness, my old friend...\x01",
            "I've come to be looted again...\x07\x00\x02",
        )
    )
    ...
    def Function_3_C21(): pass

    label("Function_3_C21")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D0B")
    Sound(14, 0, 100, 0)
    OP_71(0x5, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_CA1")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(
        ...
        (
            scpstr(0x6),
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "You grimace in horror at the anatomically\x01",
            "correct treasure chest.\x07\x00\x02",
        )
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xF5, 5)), scpexpr(EXPR_END)), "loc_DD0")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_EDD")
    Fade(500)
