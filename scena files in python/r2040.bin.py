...
def main():
    ...
    BuildStringList((
        ...
        "br2000",                 # 2
        "br2000",                 # 3
        "To Crossbell City & Mainz Mining Village",# 4
        "To Doll Studio",         # 5
    ))

    ATBonus("ATBonus_94", 100, 5, 1, 5, 1, 5, 1, 5, 5, 0, 0, 0, 1, 0, 0, 0)

    Sepith("Sepith_A4", 10,  2,   0,   4,   0,   5,   2)
    ...
    MonsterBattlePostion("MonsterBattlePostion_124", 5, 9, 180)
    MonsterBattlePostion("MonsterBattlePostion_128", 11, 9, 180)
    ...
    BattleInfo(
        "BattleInfo_144", 0x0010, 14, 6, 90, 0, 1, 5, 0, "br2000", "Sepith_A4", 30, 40, 20, 10,
        (
            ("ms77400.dat", 0, 0, 0, 0, 0, "ms77400.dat", 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms77400.dat", "ms77400.dat", 0, 0, 0, 0, "ms77400.dat", 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms77400.dat", "ms77400.dat", "ms62500.dat", 0, 0, 0, "ms77400.dat", 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms77400.dat", "ms77400.dat", "ms77400.dat", "ms62500.dat", 0, 0, "ms77400.dat", 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_20C", 0x0000, 14, 6, 45, 10, 1, 40, 0, "br2000", "Sepith_B4", 30, 40, 20, 10,
        (
            ("ms65500.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms65500.dat", "ms65500.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms65500.dat", "ms62500.dat", "ms65500.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_C4", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
            ("ms65500.dat", "ms65500.dat", "ms69400.dat", "ms65500.dat", 0, 0, 0, 0, "MonsterBattlePostion_104", "MonsterBattlePostion_E4", "ed7400", "ed7403", "ATBonus_94"),
        )
    )

    BattleInfo(
        "BattleInfo_2D4", 0x0C00, 255, 6, 0, 0, 0, 0, 0, "br2000", 0x00000000, 100, 0, 0, 0,
        (
            ("ms64301.dat", "ms64301.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_124", "MonsterBattlePostion_E4", "ed7401", "ed7403", "ATBonus_94"),
            (),
            (),
            (),
        )
    ...
    DeclMonster(12080,   52050,   17990,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(10960,   58330,   18000,   0x1010000,    "BattleInfo_20C", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(50640,   68970,   26000,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(43200,   97050,   30000,   0x1010000,    "BattleInfo_20C", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(17560,   116590,  30000,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(70050,   122300,  40000,   0x1010000,    "BattleInfo_144", 0,   16,  0xFFFF, 2,  3)
    DeclMonster(-1580,   77570,   23000,   0x18500B4,    "BattleInfo_2D4", 0,   20,  0xFFFF, 4,  5)
    ...
    PlaceName(-3.25, 0.0, -1.25, 0x0000, 0x0000, "To Crossbell City & Mainz Mining Village")
    ...
    def Function_1_5ED(): pass

    label("Function_1_5ED")

    Return()

    # Function_1_5ED end

    def Function_2_5EE(): pass

    label("Function_2_5EE")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_60B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x78, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_61F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x104, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_64D")
    OP_70(0x0, 0x0)
    Jump("loc_651")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x104, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_664")
    OP_70(0x1, 0x0)
    Jump("loc_668")
    ...
    OP_65(0x2, 0x1)
    OP_65(0x3, 0x1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x7A, 7)), scpexpr(EXPR_END)), "loc_6CE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x7B, 0)), scpexpr(EXPR_END)), "loc_727")
    LoadEffect(0x9, "event\\eva00_00.eff")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x64, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_736")
    ...
    def Function_3_737(): pass

    label("Function_3_737")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x104, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_821")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F8, 1)"), scpexpr(EXPR_END)), "loc_7B7")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Chest messaging rates may apply.\x07\x00\x02",
        )
    )
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x104, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_962")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_8F8")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(
        ...
        (
            scpstr(0x6),
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Inside the chest, you discover the secret city of Chestbell.\x07\x00\x02",
        )
    )
    ...
    def Function_6_9E9(): pass

    label("Function_6_9E9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x78, 1)), scpexpr(EXPR_END)), "loc_A07")
    Return()
    ...
    Battle("BattleInfo_2D4", 0x0, 0x0, 0x100, 0x0, 0xFF)
    OP_E0(0x2)
    EventBegin(0x1)
