...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x108, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1C7")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_15D")
    ...
    AnonymousTalk(
        ...
        (
            ...
            "You need the 'More Chest Messages' DLC\x01",
            "to view this message.\x07\x00\x02",
        )
    )
